  ...
  function generatePDF() {
    ...
    const documentDefinition = {
      content: [
        ...
        {
          text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris aliquam pulvinar dolor urna enim vitae vel. Ultrices eget ut. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris aliquam pulvinar dolor urna enim vitae vel. Ultrices eget ut",
          fontSize: 10,
          margin: [20, 0, 20, 20],
        },
        {
          text: "Generated using Latest Swipe Billing App",
          fontSize: 8,
          color: "green",
          margin: [20, 10, 20, 0],
        },
  ...
  return (
    <>
      <div className="head-tag">
        ...
        <p className="tagline">Simple Billing and Payments App</p>
      </div>
      <div className="root-bill">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="form-ui">
          ...
          <div className="row-1">
            ...
            />
            {errors.customerName && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
            ...
            />
            {errors.customerAddress && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
            ...
            />
            {errors.customerContact && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          ...
          />
          {errors.shopkeeperName && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          ...
          />
          {errors.shopkeeperAddress && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          ...
          />
{errors.shopkeeperContact && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          ...
          />
          {errors.shopkeeperEmail && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          <div>
            <label>Upload Signature</label>
            <input
            {...register("sign", { required: true })} type="file" onChange={handleImageChange} />
          </div>
          {errors.sign && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          <h5>Items details</h5>
          ...
          />
          {errors.dateInput && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          ...
          />
          {errors.invoiceNumber && <p style={{color: "red", fontSize: "10px"}}>This field is required</p>}
          <br></br>
